...
ALTER TABLE TASK ADD CONSTRAINT PK_TASK
	PRIMARY KEY (ID);
ALTER TABLE USEER ADD CONSTRAINT PK_USEER
	PRIMARY KEY (ID);
...
ALTER TABLE USEER
	ADD CONSTRAINT UQ_USEER UNIQUE (UUID);
...
-- Reference from Communication.sender to Useer
ALTER TABLE COMMUNICATION ADD CONSTRAINT FK_COMMUNICATION_SENDER
	FOREIGN KEY (SENDER) REFERENCES USEER (ID);
CREATE INDEX IX_COMMUNICATION_SENDER ON COMMUNICATION (SENDER);

-- Reference from Communication.recipient to Useer
ALTER TABLE COMMUNICATION ADD CONSTRAINT FK_COMMUNICATION_RECIPIENT
	FOREIGN KEY (RECIPIENT) REFERENCES USEER (ID);
CREATE INDEX IX_COMMUNICATION_RECIPIENT ON COMMUNICATION (RECIPIENT);

-- Reference from TimeLine.useer to Useer
ALTER TABLE TIMELINE ADD CONSTRAINT FK_TIMELINE_USEER
	FOREIGN KEY (USEER) REFERENCES USEER (ID);
CREATE INDEX IX_TIMELINE_USEER ON TIMELINE (USEER);
