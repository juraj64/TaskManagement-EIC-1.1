...
/**
 * Generated base class for implementation of ProjectResource.
 * <p>
...
public abstract class ProjectResourceBase {
	...
	public String show(@PathVariable("id") Long id, ModelMap modelMap) throws ProjectNotFoundException {
		Project result = projectService.findById(serviceContext(), id);
	...
	public String showAll(ModelMap modelMap) {
		List<Project> result = projectService.findAll(serviceContext());
		modelMap.addAttribute("result", result);
		return "project/showlist";
	}

	@RequestMapping(value = "/project", method = RequestMethod.POST)
	public String create(@RequestBody Project entity) {
		Project result = projectService.save(serviceContext(), entity);
		return String.format("redirect:/rest/project/%s", result.getId());
	}

	@RequestMapping(value = "/project/{id}", method = RequestMethod.DELETE)
	public String delete(@PathVariable("id") Long id) throws Exception {
		Project deleteObj = projectService.findById(serviceContext(), id);
		projectService.delete(serviceContext(), deleteObj);
		return "redirect:/rest/project";
	}

	/*
	 * @org.springframework.web.bind.annotation.RequestMapping(value = "/project/form",
	 ...
	 */
	@RequestMapping(value = "/project", method = RequestMethod.POST, headers = "content-type=application/x-www-form-urlencoded")
	public String createFromForm(@ModelAttribute("entity") Project entity) {
		return create(entity);
	}

	@ExceptionHandler
	public void handleException(ProjectNotFoundException e, HttpServletResponse response) throws IOException {
