...
/**
 * Generated base class for implementation of UseerResource.
 * <p>
 ...
 * </pre>
 */
public abstract class UseerResourceBase {

	public UseerResourceBase() {
	}
	...
	protected UseerService getUseerService() {
		return useerService;
	}

	@RequestMapping(value = "/useer/{id}", method = RequestMethod.GET)
	public String show(@PathVariable("id") Long id, ModelMap modelMap) throws UseerNotFoundException {
		Useer result = useerService.findById(serviceContext(), id);
		modelMap.addAttribute("result", result);
		return "useer/show";
	}

	@RequestMapping(value = "/useer", method = RequestMethod.GET)
	public String showAll(ModelMap modelMap) {
		List<Useer> result = useerService.findAll(serviceContext());
		modelMap.addAttribute("result", result);
		return "useer/showlist";
	}

	@RequestMapping(value = "/useer", method = RequestMethod.POST)
	public String create(@RequestBody Useer entity) {
		Useer result = useerService.save(serviceContext(), entity);
		return String.format("redirect:/rest/useer/%s", result.getId());
	}

	@RequestMapping(value = "/useer/{id}", method = RequestMethod.DELETE)
	public String delete(@PathVariable("id") Long id) throws Exception {
		Useer deleteObj = useerService.findById(serviceContext(), id);
		useerService.delete(serviceContext(), deleteObj);
		return "redirect:/rest/useer";
	}

	/*
	 * @org.springframework.web.bind.annotation.RequestMapping(value = "/useer/form",
	 ...
	 */
	@RequestMapping(value = "/useer", method = RequestMethod.POST, headers = "content-type=application/x-www-form-urlencoded")
	public String createFromForm(@ModelAttribute("entity") Useer entity) {
		return create(entity);
	}

	@ExceptionHandler
	public void handleException(UseerNotFoundException e, HttpServletResponse response) throws IOException {
